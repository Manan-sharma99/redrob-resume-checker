...
- **Stage 6: Sensitivity**: PASS - Top 100 highly stable (min overlap 99/100) across 12 parameter perturbations.
...
- **Stage 10: Regression Diff**: PASS - Saved 50 largest rank disagreements against v011 to ranking_diff.csv