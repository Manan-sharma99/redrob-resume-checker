...
## Warnings
- **Stage 9: Score Collapse (Top 250)**: WARNING - Found 17 adjacent pairs with score diff < 1e-05
...
## Passed Checks
- **Stage 2: Elite Sets**: PASS - Generated 50 elite candidates using dynamic percentiles (Rel>0.28, Prod>39.00).
- **Stage 9: Score Resolution (Top 100)**: PASS - Only 4 near-ties detected (eps=1e-05).
- **Stage 3: Pairwise Stability (Top 100)**: PASS - Most fragile pair rel_diff=0.000000 at rank 20/21.
- **Stage 3: Pairwise Stability (Top 250)**: PASS - Most fragile pair rel_diff=0.000000 at rank 20/21.
...
- **Stage 10: JD Coverage**: PASS - Search/IR >50: 99%, RecSys >50: 5%, Prod >50: 20%
- **Stage 10: Regression Diff**: PASS - Saved 50 largest rank disagreements against v004 to ranking_diff.csv